...
class AboutCmsSettings extends Page implements HasForms
{
    ...
    protected static ?string $navigationLabel = 'CMS / About';

    protected static ?string $title = 'CMS & About Content';
