<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
	...
	<form wire:submit.prevent="placeOrder">
		...
		<div class="md:col-span-12 lg:col-span-8 col-span-12">
			...
			<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
				...
				<ul class="grid w-full gap-6 md:grid-cols-2">
					<li>
						<input wire:model="payment_method" class="hidden peer" id="hosting-small" required="" type="radio" value="cash_on_delivery" />
					...
					<li>
						<input wire:model="payment_method" class="hidden peer" id="hosting-big" name="hosting" type="radio" value="bkash" />
		...
		<div class="md:col-span-12 lg:col-span-4 col-span-12">
			...
			<button class="bg-black mt-4 w-full p-3 rounded-lg text-lg text-white hover:bg-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600 cursor-pointer" type="submit">
				Place Order
			</button>
					...
					@foreach ($cart_items as $item)
						...
						<div class="flex items-center">
							<div class="flex-shrink-0">
								<img alt="Neil image" class="w-12 h-12 rounded-full" src="{{ $item['image'] ? url('storage', $item['image']) : "https://placehold.co/150" }}">
								</img>
							</div>
