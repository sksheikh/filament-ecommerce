<div>
    ...
    <section class="w-full bg-gradient-to-r from-blue-50 to-cyan-50 py-16">
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <!-- Card 1 -->
            <a class="group flex flex-col bg-white border border-transparent hover:border-blue-200 shadow-sm rounded-2xl hover:shadow-md transition-transform hover:-translate-y-1 p-5" href="#">
                <div class="flex justify-between items-center">
                <div class="flex items-center">
                    <img class="h-10 w-10 rounded-full ring-2 ring-blue-100" src="https://cdn.bajajelectronics.com/product/b002c02c-c379-49f8-b2a6-bd2e56d0e23a" alt="Laptop">
                    <div class="ms-3">
                    <h3 class="font-semibold text-gray-800 group-hover:text-blue-600">Laptops</h3>
                    <p class="text-sm text-gray-500">Powerful and portable</p>
                    </div>
                </div>
            ...
            <a class="group flex flex-col bg-white border border-transparent hover:border-blue-200 shadow-sm rounded-2xl hover:shadow-md transition-transform hover:-translate-y-1 p-5" href="#">
                <div class="flex justify-between items-center">
                <div class="flex items-center">
                    <img class="h-10 w-10 rounded-full ring-2 ring-blue-100" src="https://static.toiimg.com/thumb/msid-86223197,width-400,resizemode-4/86223197.jpg" alt="Smartphones">
                    <div class="ms-3">
                    <h3 class="font-semibold text-gray-800 group-hover:text-blue-600">Smartphones</h3>
                    <p class="text-sm text-gray-500">Latest mobile devices</p>
                    </div>
                </div>
                <div class="text-blue-500 group-hover:translate-x-1 transition-transform">
                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2"
            ...
            <a class="group flex flex-col bg-white border border-transparent hover:border-blue-200 shadow-sm rounded-2xl hover:shadow-md transition-transform hover:-translate-y-1 p-5" href="#">
                <div class="flex justify-between items-center">
                <div class="flex items-center">
                    <img class="h-10 w-10 rounded-full ring-2 ring-blue-100" src="https://store.storeimages.cdn-apple.com/4668/as-images.apple.com/is/watch-card-40-ultra2-202309_GEO_IN_FMT_WHH?wid=508&hei=472&fmt=p-jpg&qlt=95&.v=1693611639854" alt="Smartwatches">
                    <div class="ms-3">
                    <h3 class="font-semibold text-gray-800 group-hover:text-blue-600">Smartwatches</h3>
                    <p class="text-sm text-gray-500">Stylish and connected</p>
                    </div>
                </div>
                <div class="text-blue-500 group-hover:translate-x-1 transition-transform">
                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2"
            ...
            <a class="group flex flex-col bg-white border border-transparent hover:border-blue-200 shadow-sm rounded-2xl hover:shadow-md transition-transform hover:-translate-y-1 p-5" href="#">
                <div class="flex justify-between items-center">
                <div class="flex items-center">
                    <img class="h-10 w-10 rounded-full ring-2 ring-blue-100" src="https://i01.appmifile.com/v1/MI_18455B3E4DA706226CF7535A58E875F0267/pms_1632893007.55719480!400x400!85.png" alt="Television">
                    <div class="ms-3">
                    <h3 class="font-semibold text-gray-800 group-hover:text-blue-600">Television</h3>
                    <p class="text-sm text-gray-500">Experience 4K visuals</p>
                    </div>
                </div>
                <div class="text-blue-500 group-hover:translate-x-1 transition-transform">
                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2"
    ...
    <section class="py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/4">
